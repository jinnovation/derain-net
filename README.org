...
*** Input Function 
    ...
    First, let's set up the input function for our [[https://www.tensorflow.org/programmers_guide/estimators][Estimator]], using the accessor
    abstraction we introduced earlier:
